...
// TCP is encodable TCPAddr
type TCP net.TCPAddr

// Encode encode TCPAddr data into bytes
func (t *TCP) Encode(b []byte) (int, error) {
	ip4 := t.IP.To4()
...
// Decode decodes a byte to build a TCPAddr
